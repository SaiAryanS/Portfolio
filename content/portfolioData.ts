...
AI-powered tools to DevOps-automated pipelines.`,
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        'Intelligent expense tracking app with AI-driven categorization, trend analysis, and financial summaries. Built entirely in TypeScript with a clean, minimal interface.',
      tech: ['TypeScript', 'Next.js', 'AI'],
      github: 'https://github.com/SaiAryanS/AI-Expense-Tracker',
      live: null,
      period: 'Sep 2025',
      featured: false,
    },
    {
      ...
      description:
        'Privacy-first conversational AI running open-source LLMs entirely on local hardware via Ollama. No cloud dependency, no data leakage — full control over inference.',
      tech: ['Python', 'Ollama', 'LLM', 'Streamlit'],
